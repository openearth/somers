...
tbl = "hdsr_timeseries.location"
nwtbl = "hdsr_timeseries.location_metadata2"
...
#     strsql = f"""
#     UPDATE hdsr_timeseries.location_metadata2 m2
#     SET {rename_cols[i]} = m1.{rename_cols[i]}
#     FROM hdsr_timeseries.location_metadata m1
...
assign_ahn4.assign_ahn(engine, "hdsr_timeseries.location", nwtbl)
