...
tbl = "hhnk_timeseries.location"
nwtbl = "hhnk_timeseries.location_metadata2"
...
#     strsql = f"""
#     UPDATE hhnk_timeseries.location_metadata2 m2
#     SET {rename_cols[i]} = m1.{rename_cols[i]}
#     FROM hhnk_timeseries.location_metadata m1
...
assign_ahn4.assign_ahn(engine, "hhnk_timeseries.location", nwtbl)
