...
class TimeStep(Base):
    ...
    __table_args__ = {'schema': 'wskip_timeseries'}
    timestepkey    = Column(Integer,Sequence('wskip_timeseries.timesteps_timestepkey_seq'),primary_key=True)
...
class TimeSeries(Base):
    ...
    __table_args__ = {'schema': 'wskip_timeseries'}
    timeserieskey          = Column(Integer, Sequence('wskip_timeseries.timeserieskeys_timeserieskey_seq'),primary_key=True)
    locationkey            = Column(Integer, ForeignKey('wskip_timeseries.location.locationkey', ondelete='CASCADE'))
    parameterkey           = Column(Integer, ForeignKey('wskip_timeseries.parameter.parameterkey', ondelete='CASCADE'))
    timestepkey            = Column(Integer, ForeignKey('wskip_timeseries.timesteps.timestepkey', ondelete='CASCADE'))
    filesourcekey          = Column(Integer, ForeignKey('wskip_timeseries.filesource.filesourcekey', ondelete='CASCADE'))
...
class TimeSeriesComments(Base):
    ...
    __table_args__ = {'schema': 'wskip_timeseries'}
    timeserieskey  = Column(Integer,ForeignKey('wskip_timeseries.timeseries.timeserieskey', ondelete='CASCADE'),primary_key=True)
...
class Users(Base):
    __tablename__  = 'users'
    __table_args__ = {'schema': 'wskip_timeseries'}
    userkey        = Column(Integer,Sequence('wskip_timeseries.users_userkey_seq'),primary_key=True)
    id             = Column(String, unique=True,nullable=False)
    name           = Column(String)
...
class Flags(Base):
    __tablename__  = 'flags'
    __table_args__ = {'schema': 'wskip_timeseries'}
    flagkey        = Column(Integer,Sequence('wskip_timeseries.users_flagkey_seq'),primary_key=True)
    id             = Column(String, unique=True,nullable=False)
    name           = Column(String)    
...
class TimeSeriesManualEditsHistory(Base):
    ...
    datetime       = Column(DateTime, primary_key = True)
    userkey        = Column(Integer,ForeignKey('wskip_timeseries.users.userkey', ondelete='CASCADE'))
...
class TimeSeriesValuesAndFlags(Base):
    ...
    __table_args__ = (PrimaryKeyConstraint('timeserieskey', 'datetime','scalarvalue'),{'schema': 'wskip_timeseries'})
    timeserieskey  = Column(Integer, ForeignKey('wskip_timeseries.timeseries.timeserieskey', ondelete='CASCADE'), nullable = False)
    datetime       = Column(DateTime, nullable=False)
    scalarvalue    = Column(Float,nullable=False)
    flags          = Column(Integer,ForeignKey('wskip_timeseries.flags.flagkey', ondelete='CASCADE'), nullable=False)

"""records pump history"""
class Parameter(Base):
    __tablename__      = 'parameter'
    __table_args__     = {'schema': 'wskip_timeseries'}
    parameterkey       = Column(Integer,Sequence('wskip_timeseries.parameter_parameterkey_seq'),primary_key=True)
    id                 = Column(String)    
    name               = Column(String)
    unitkey            = Column(Integer, ForeignKey('wskip_timeseries.unit.unitkey', ondelete='CASCADE'))
...
class Unit(Base):
    __tablename__      = 'unit'
    __table_args__     = {'schema': 'wskip_timeseries'}    
    unitkey            = Column(Integer,Sequence('wskip_timeseries.unitdesc_seq'),primary_key=True)
...
class FileSource(Base):
    ...
    __table_args__ = {'schema': 'wskip_timeseries'}    
    filesourcekey  = Column(Integer,Sequence('timeseries.filesource_seq'),primary_key=True)
...
class Transaction(Base):
    ...
    __table_args__  = {'schema': 'wskip_timeseries'}    
    transactionkey  = Column(Integer,Sequence('wskip_timeseries.transaction_seq'),primary_key=True)
    timeserieskey   = Column(Integer, ForeignKey('wskip_timeseries.timeseries.timeserieskey', ondelete='CASCADE'), nullable = False)
...
class Location(Base):
    ...
    __table_args__ = {'schema': 'wskip_timeseries'}
    locationkey        = Column(Integer,Sequence('wskip_timeseries.location_locationkey_seq1'),primary_key=True)    #key
    filesourcekey      = Column(Integer,ForeignKey('wskip_timeseries.filesource.filesourcekey', ondelete='CASCADE'))  #fskey
